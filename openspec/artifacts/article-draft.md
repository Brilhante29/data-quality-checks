# #26 data-quality-checks: F1 1.0000 at 717,607.98 rows/s
...
The benchmark is the proof: invalid-row detection F1 is 1.0000, median throughput is 717,607.98 rows/s, and false positives and false negatives are zero. The contract-valid result is stored in `benchmarks/publication/data-quality-v2.json` and is reproduced by `./tools/benchmark.ps1`.
